...
//	wifi.connectFlag = 1;
	...
	{
		case 0x00: Motor_Stop(); break;// 刹车
		case 0x01: Motor_Front(500); break;		// 前进
		case 0x02: Motor_Back(500); break;		// 后退		
		case 0x03: Motor_Left(500); break;		// 左转		
		case 0x04: Motor_Right(500); break;	// 右转
        case 0x0A: Motor_Right(350); break;	// 速度:慢速
        case 0x0B: Motor_Right(500); break;	// 速度:正常
        case 0x0C: Motor_Right(650); break;	// 速度:快速
