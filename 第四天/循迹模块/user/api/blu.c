...
void Blue_Analysis(void)
{
	...
	//		BluValue = '0' + blueBuff[2];
		switch(blueBuff[2])
		{
            ...
            case 0x06: Motor_Front(450); break;     //电机控制前进
            case 0x05: Motor_Back(450); break;      //电机控制后退
            case 0x04: Motor_Left(450); break;      //电机控制左转
            case 0x03: Motor_Right(450); break;     //电机控制右转
            case 0x07: Motor_Stop(); break;         //电机控制停止
		}
		ERROR:
		recvCount = 0;
